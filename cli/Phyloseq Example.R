...
DATAPATH = "/Users/Andi/Development/tmp/data/phyloseq/"
ABUNDANCE_PROFILE_AMPLICON_GREENGENES = "amplicon.greengenes.biom"
# reading json/biom file

amplicon.biom = read_biom( paste( DATAPATH , ABUNDANCE_PROFILE_AMPLICON_GREENGENES , sep=""))
...
OTUTABLE = otu_table(otumatrix, taxa_are_rows=TRUE)
...
amplicon = phyloseq(OTUTABLE, TAX , META)
